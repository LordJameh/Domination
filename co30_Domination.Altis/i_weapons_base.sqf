...
if (d_with_ace) then {
	((_all_weapons_items # 6) # 2) append ["ACE_atropine", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_quikclot", "ACE_bloodIV", "ACE_bloodIV_500", "ACE_bloodIV_250",
		...
		"ACE_plasmaIV_250", "ACE_salineIV", "ACE_salineIV_500", "ACE_salineIV_250", "ACE_surgicalKit", "ACE_tourniquet", "ACE_EarPlugs", "ACE_DeadManSwitch",
		"ACE_DefusalKit", "ACE_Clacker", "ACE_splint"];
};
